...
// conduit-ledger's copy of the same file rather than factored into a shared
// module — see docs/learning for why (each service stays self-contained and
// independently deployable, at the cost of ~90 lines of duplication).
package db
