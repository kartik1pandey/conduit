...
// runner shared by cmd/server and cmd/migrate.
package db
...
// transaction. This is a deliberately small hand-rolled runner instead of a
// dependency like golang-migrate: one file format (plain "up" SQL), no
// rollback support, no CLI — enough for a project with no other engineers
// running conflicting migrations concurrently. golang-migrate would be the
// right call the day this needs down-migrations or multiple people writing
